      ...
      <div class="row">
          ...
          <div class="col-lg-9">
            ...
            @include('front.message')   <!-- profile updated successfully msg -->
              ...
              <div>
              {{ $applications->links() }}  <!--'paginate' link-->
              </div>
          </div>
...
<script type="text/javascript"> 
    function deleteJobApplication(id){  // delete button onclick function
        if(confirm("Are you sure you want to delete?")){
            $.ajax({
                url:'{{ route("admin.jobApplications.destroy") }}', //admin wisin jobs delete kirima
