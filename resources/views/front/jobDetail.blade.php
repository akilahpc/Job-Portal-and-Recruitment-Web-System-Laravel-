              ...
              <div class="card shadow border-0">
                  ...
                  <div class="descript_wrap white-bg">
                              ...
                              <div class="single_wrap">
                                  ...
                                  {!! nl2br( $job->description) !!}  <!--  '!! nl2br() !!' new line ekkt yaddi break line break krnn-->
                              </div>

                            @if(!empty($job->responsibility)) <!--'job post' eke 'responsibility' fels ek 'not empty' nam pamanak-->
                              <div class="single_wrap">
                                <h4>Responsibility</h4>
                                {!! nl2br( $job->responsibility ) !!} <!--'job detail' page eke ema 'responsibility' penwanna -->
                              </div>
                            @endif
                      ...
                      <div class="pt-3 text-end">
                          ...
                          @if(Auth::check()) <!--user Login wela nam inne-->
              ...
              <div class="card shadow border-0">
                  <div class="job_sumary">
                      ...
                      <div class="job_content pt-3">
                          <ul>
                              <li>Published on: <span>{{ \Carbon\Carbon::parse($job->created_at)->format('d M, Y') }}</span></li> <!--add 'created_at' date-->
