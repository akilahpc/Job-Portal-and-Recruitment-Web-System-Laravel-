          ...
          <div class="col-6 col-md-2">
              <div class="align-end">
                  <select name="sort" id="sort" class="form-control">
                      <option value="1" {{ (Request::get('sort') == '1') ? 'selected' : '' }}>Latest</option> <!--'Latest select kroth url rke 1 display'-->
                      <option value="0" {{ (Request::get('sort') == '0') ? 'selected' : '' }}>Oldest</option> <!--'Oldest select kroth url rke 0 display'-->
                  </select>
              </div>
          </div>
      </div>
          ...
          <div class="col-md-4 col-lg-3 sidebar mb-4">
            <form action="" name="searchForm" id="searchForm">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Keywords</h2>
                            <input value="{{ Request::get('keyword') }}" type="text" name="keyword" id="keyword" placeholder="Keywords" class="form-control"> <!--'value="{ Request::get('keyword') }}"' ->searching part relate-->
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                @if ($categories) <!--'categories' table eken aran display kirima-->
                        ...
                        <div class="mb-4">
                            ...
                            <select name="experience" id="experience" class="form-control">
                                ...
                                <option value="1" {{ (Request::get('experience') == 1) ? 'selected' : '' }}>1 Year</option> <!--'{ (Request::get('experience') == 1) ? 'selected' : '' }}' -> searching part relates-->
          ...
          <div class="col-md-8 col-lg-9 ">
              <div class="job_listing_area">                    
                  ...
                  <div class="row">
                    ...
                    @if($jobs->isNotEmpty()) <!--"jobs" page eke 'jobs' table eke athi jobs penwima-->

                        @foreach($jobs as $job) <!--mehi '$jobs' variable create ->'jobsController'-->
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    {{--<p>Category: {{ $job->category->name }}</p> <!--job post eke 'category name' display kirima-->
...
@section('customJs')
<script> //search form eke 'search' button press & searching process
    $("#searchForm").submit(function(e){
        ...
        // If keyword has a avalue
        if(keyword != ""){
            url += '&keyword='+keyword;
        }
        // If location has a avalue
        if(location != ""){
            url += '&location='+location;
        }
        // If category has a avalue
        if(category != ""){
            url += '&category='+category;
        }
        // If experience has a avalue
        if(experience != ""){
