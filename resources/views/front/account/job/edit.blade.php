  ...
  <div class="container py-5">
      ...
      <div class="row">
          <div class="col-lg-3">
            ...
            @include('front.account.sidebar')  <!-- link the sidebar -->
...
$("#editJobForm").submit(function(e){
    ...
    $.ajax({
        url:'{{ route("account.updateJob",$job->id) }}',   //route name
        type:'POST',
        dataType:'json',
          ...
          $("button[type='submit']").prop('disabled',false);
            if(response.status==true){    //{173-206}  form eke aniwaren fill kala yuthu '*' ek ek feelds fill krla nam error msg ek ain kirima
                ...
                $("#title").removeClass('is-invalid')
                 ...
                 window.location.href="{{ route('account.myJobs') }}";  //'account.myJobs' -> route name
